・プロジェクトメンバー...momonga
・プログラムの解説.......現在時刻の表示(環境的におそらくこの場所だと数分ずれますが)
・作動方法...............controlキー + f5キー



========================================================================
    コンソール アプリケーション: momonga3 プロジェクトの概要
========================================================================

この momonga3 アプリケーションは、AppWizard により作成されました。
