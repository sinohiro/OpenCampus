...
11   15   MODEL_EVENT_ADD|bootscreen          MODEL_ADD|mei|Model\LatTypeMikuP\LatTypeMikuP.pmd|0.0,0.0,-14.0
...
1    41   RECOG_EVENT_STOP|自己紹介           SYNTH_START|mei|mei_voice_happy|ミクと言います。
1    41   RECOG_EVENT_STOP|あなた,誰          SYNTH_START|mei|mei_voice_happy|ミクと言います。
1    41   RECOG_EVENT_STOP|君,誰              SYNTH_START|mei|mei_voice_happy|ミクと言います。
